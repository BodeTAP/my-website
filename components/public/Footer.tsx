      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-linear-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-500/20">
                <Image src={settings.brand_logo_url || "/logo.png"} alt={settings.brand_name} width={24} height={24} className="brightness-0 invert" />
              </div>
              <span className="font-bold text-xl text-white tracking-wide">{settings.brand_name}</span>
            </div>
            ...
            <div className="flex items-center gap-4">
              {settings.social_instagram_url && <a href={settings.social_instagram_url} aria-label="Instagram" className="w-10 h-10 rounded-full glass flex items-center justify-center text-blue-300 hover:text-white hover:bg-blue-600 hover:border-blue-500 transition-all">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </a>}
              {settings.social_facebook_url && <a href={settings.social_facebook_url} aria-label="Facebook" className="w-10 h-10 rounded-full glass flex items-center justify-center text-blue-300 hover:text-white hover:bg-blue-600 hover:border-blue-500 transition-all">
              ...
              {settings.social_linkedin_url && <a href={settings.social_linkedin_url} aria-label="LinkedIn" className="w-10 h-10 rounded-full glass flex items-center justify-center text-blue-300 hover:text-white hover:bg-blue-600 hover:border-blue-500 transition-all">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-blue-100/50 text-sm">
                ...
                <span>+{settings.brand_public_whatsapp}</span>
              </li>
              <li className="flex items-center gap-3 text-blue-100/50 text-sm">
                <Mail className="w-5 h-5 text-blue-400 shrink-0" />
                <span>{settings.brand_contact_email}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-blue-100/30 text-xs sm:text-sm">
            © {year} {settings.brand_footer_text}
          </p>
